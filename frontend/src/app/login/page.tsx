        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link href="/signup" className="text-red-500 hover:text-red-600 transition-colors font-medium">Become a Technician</Link>
            </nav>
        ...
        <div className="max-w-md w-full space-y-8 relative z-10">
          ...
          <div className="text-center">
            <div className="flex justify-center mb-6">
              <div className="tech-icon w-16 h-16 rounded-full flex items-center justify-center bg-gradient-to-br from-green-500 to-green-600">
            ...
            <p className="text-gray-600">Sign in to your TechCare account to get tech help</p>
          </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-red-500 focus:ring-3 focus:ring-red-500/10 transition-all duration-200"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-red-500 focus:ring-3 focus:ring-red-500/10 transition-all duration-200 pr-12"
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link href="/forgot-password" className="text-red-500 hover:text-red-600 font-medium transition-colors">
